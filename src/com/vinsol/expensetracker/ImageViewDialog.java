...
public class ImageViewDialog extends Dialog implements android.content.DialogInterface.OnDismissListener, android.content.DialogInterface.OnCancelListener{
...
//		_id = getBundleExtras.getLong("_id");
	...
	private class ImageViewAsyncTask extends AsyncTask<Void, Void, Void>{
		...
		protected Void doInBackground(Void... params) {
			drawable = Drawable.createFromPath("/mnt/sdcard/ExpenseTracker/"+_id+".jpg");
			return null;
		}
