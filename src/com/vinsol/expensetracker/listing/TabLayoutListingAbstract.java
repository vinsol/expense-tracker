...
////					j = taskOnPrevWeekMonthYear(toCHeckCal, i, j, mList, mDisplayDate);
//					break;
//				default:
//					break;
//				}
...
//				}
	...
	private int taskOnPrevWeekMonthYear(Calendar toCHeckCal, int i, int j, List<Entry> mList, DisplayDate mDisplayDate) {
//		toCHeckCal.setTimeInMillis(mSubList.get(j).timeInMillis);
//		toCHeckCal.setFirstDayOfWeek(Calendar.MONDAY);
...
//		}
	...
	protected abstract Entry getList(int j);
